...
- **Custom Timer & Stopwatch**: Set exact custom durations or run an open-ended stopwatch.
- **Auto-Save Progress**: Never lose your running timer or elapsed seconds, even if you accidentally close or refresh your browser tab.

### 🎧 Ambient Atmosphere Soundscapes
Immerse yourself in background acoustics tailored for concentration:
- 🌧️ **Rain on Leaves** & **Stormy Weather**
...
npm run dev
```
Open [http://localhost:3000](http://localhost:3000) in your browser to start focusing!
